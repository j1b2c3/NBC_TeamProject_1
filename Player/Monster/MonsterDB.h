...
public:
    static Monster* Create(int stageLevel)
    {
        ...
        case 5: return new Monster("트롤", 5, 320, 40, 48, 12, 100, 100, 600, 1100);
        case 6: return new Monster("와이번", 6, 380, 55, 65, 18, 100, 100, 850, 1600);
        case 7: return new Monster("데몬", 7, 500, 75, 85, 22, 100, 100, 1200, 2300);
        case 8: return new Monster("드래곤", 8, 950, 170, 130, 25, 100, 100, 1700, 3300);
        case 9: return new Monster("고대용", 9, 1750, 240, 170, 30, 100, 100, 2500, 5000);
        // 스테이지 0에서 히든 미믹
...
public:
    FinalBoss() : Monster("최종 보스", 10, 9999, 500, 500, 20, 1000, 1000, 1000, 1000)
    {
    }
